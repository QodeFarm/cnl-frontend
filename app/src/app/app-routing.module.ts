...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'profile', title: 'Profile', canActivate: [], loadChildren: () => import('./admin/profile/profile.module').then(m => m.ProfileModule) },
      ...
      { path: 'users', data: { title: 'Users', moduleName: 'dashboard' }, canActivate: [], loadChildren: () => import('./admin/user/user.module').then(m => m.UserModule) },
      { path: 'sales', data: { title: 'Sales', moduleName: 'dashboard' }, canActivate: [], loadChildren: () => import('./admin/sales/sales.module').then(m => m.SalesModule) },
      // { path: 'employee', canActivate: [], loadChildren: () => import('./admin/employee/employee.module').then(m => m.EmployeeModule) },
      { path: 'master', data: { title: 'Master', moduleName: 'dashboard' }, pathMatch: 'full', redirectTo: 'master/master' },
