...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'finance/opening-balance', data: { title: 'Opening Balance', moduleName: 'opening-balance' }, canActivate: [], loadComponent: () => import('./admin/finance/opening-balance/opening-balance.component').then(m => m.OpeningBalanceComponent) },
      ...
      { path: 'company/company-settings', data: { title: 'Company Settings', moduleName: 'company-settings' }, canActivate: [], loadComponent: () => import('./admin/company/company-settings/company-settings.component').then(m => m.CompanySettingsComponent) },
      ...
      { path: 'reports/inventory-reports', data: { title: 'Inventory Reports', moduleName: 'inventory-reports' }, canActivate: [], loadComponent: () => import('./admin/reports/inventory-reports/inventory-reports.component').then(m => m.InventoryReportsComponent) },
      { path: 'reports/audit-logs', data: { title: 'User Activity', moduleName: 'audit-logs' }, canActivate: [], loadChildren: () => import('./admin/audit-logs/audit-logs.module').then(m => m.AuditLogsModule) },
