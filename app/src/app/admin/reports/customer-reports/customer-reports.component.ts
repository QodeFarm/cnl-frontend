  ...
  isAccordionOpen = true;
    ...
    reportsConfig: { [key: string]: TaTableConfig } = {
      ...
      CustomerSummaryReport: {
        ...
        export: {downloadName: 'CustomerSummaryReport'},
      ...
      CustomerLedgerReport: {
        ...
        export: {downloadName: 'CustomerLedgerReport'},
       ...
       CustomerOutstandingReport: {
        ...
        export: {downloadName: 'CustomerOutstandingReport'},
      ...
      CustomerOrderHistoryReport: {
        ...
        export: {downloadName: 'CustomerOrderHistoryReport'},
        defaultSort: { key: 'created_at', value: 'descend' },
        cols: [
          {
            fieldKey: 'customer',
      ...
      CustomerCreditLimitReport: {
        ...
        export: {downloadName: 'CustomerCreditReport'},
        defaultSort: { key: 'created_at', value: 'descend' },
        cols: [
          {
            fieldKey: 'name',
      ...
      CustomerPaymentReport: {
        ...
        pageSize: 10,
        globalSearch: {
          keys: ['name', 'payment_date', 'payment_method', 'amount', 'payment_reference', 'notes']
        },
        export: {downloadName: 'CustomerPaymentReport'},
