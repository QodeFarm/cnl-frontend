...
checkAndPopulateData() {
  if (this.dataToPopulate === undefined) {
    this.route.paramMap.subscribe(() => {
      ...
      if (!Array.isArray(saleReturnItems) || saleReturnItems.length === 0) {
      ...
      saleReturnItems.forEach((item, index) => {
        this.formConfig.model.sale_return_items.push({
...
async autoFillProductDetails(field, data) {
  ...
  const fieldMappings = {
    ...
    rate: selectedRate,
    discount: !this.SaleReturnOrderEditID
                            ...
                            },
                            {
                                ...
                                hooks: {
                                  onInit: (field: any) => {
                                    ...
                                    if (this.dataToPopulate && 
                                        this.dataToPopulate.sale_return_order && 
                                        this.dataToPopulate.sale_return_order.round_off !== undefined && 
                                        this.dataToPopulate.sale_return_order.round_off !== null && 
                                        field.formControl) {
                                      field.formControl.setValue(this.dataToPopulate.sale_return_order.round_off);
                                    }
