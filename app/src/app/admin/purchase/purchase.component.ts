  ...
  if (this.dataToPopulate === undefined) {
    this.route.paramMap.subscribe(() => {
      ...
      purchaseOrderItems.forEach((item, index) => {
        this.formConfig.model.purchase_order_items.push({
    ...
    selectedProducts.forEach(newProduct => {
      ...
      if (!isDuplicate) {
        ...
        existingProducts.push({
          ...
          cgst: parseFloat(newProduct.cgst) || 0,       // Ensure tax is a number
          sgst: parseFloat(newProduct.sgst) || 0,       // Ensure tax is a number
          igst: parseFloat(newProduct.igst) || 0,       // Ensure tax is a number
...
//====================================================
  ...
  createPurchaseOrder(){
    const customFieldValues = this.formConfig.model['custom_field_values']
	  ...
	  const entityName = 'purchase_order'; // Since we're in the Sale Order form
        ...
        // end of purchase_order
        {
          ...
          fieldArray: {
            fieldGroup: [
              ...
              },   
              {
                ...
                hooks: {
                  onInit: (field: any) => {
                    ...
                    const rowData = this.formConfig.model.purchase_order_items[idx];
                ...
                hooks: {
                  onInit: (field: any) => {
                    ...
                    if (parentArray) {
                      ...
                      if (
                        this.dataToPopulate &&
                        this.dataToPopulate.purchase_order_items.length > currentRowIndex
                      ) {
                        const existingQuan =
                          this.dataToPopulate.purchase_order_items[currentRowIndex].quantity;
              ...
              //             const roundedTax = Math.round(existingTax * 100) / 100;
              //             field.formControl.setValue(roundedTax);
              //           }
              //         }
              //       }
                    
              //       // Optional: Subscribe to tax changes if you need to recalculate anything
              //       field.formControl.valueChanges.subscribe(taxValue => {
              //         // If tax changes, you might want to recalculate amount with tax
              //         if (field.form && field.form.controls) {
              //           const quantity = Number(field.form.controls.quantity?.value || 0);
              //           const rate = Number(field.form.controls.rate?.value || 0);
              //           const discount = Number(field.form.controls.discount?.value || 0);
                            ...
                            // },
                            {
                              ...
                              hooks: {
                                onInit: (field: any) => {
                                  ...
                                  if (
                                    this.dataToPopulate &&
                                    this.dataToPopulate.purchase_order_data &&
                                    this.dataToPopulate.purchase_order_data.tax_amount &&
                                    field.formControl
                                  ) {
                                    field.formControl.setValue(this.dataToPopulate.purchase_order_data.tax_amount);
                                  }
                                  ...
                                  let previousTaxAmount = parseFloat(this.dataToPopulate?.purchase_order_data?.tax_amount || "0");
                            ...
                            // },
                            {
                              ...
                              hooks: {
                                onInit: (field: any) => {
                                  ...
                                  const existing = this.dataToPopulate?.purchase_order_data?.cess_amount;
                            ...
                            },
                            {
                                ...
                                hooks: {
                                  onInit: (field: any) => {
                                    ...
                                    if (this.dataToPopulate && 
                                        this.dataToPopulate.purchase_order_data && 
                                        this.dataToPopulate.purchase_order_data.round_off !== undefined && 
                                        this.dataToPopulate.purchase_order_data.round_off !== null && 
                                        field.formControl) {
                                      field.formControl.setValue(this.dataToPopulate.purchase_order_data.round_off);
                                    }
